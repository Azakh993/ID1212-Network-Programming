...
from services.reservations_service import generate_user_reservation_entries, remove_user_reservation
...
def remove_reservation(reservation_id):
    successful_removal = remove_user_reservation(reservation_id)
